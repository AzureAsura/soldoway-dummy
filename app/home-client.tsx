      ...
      <div className="max-w-3xl w-full text-center animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            disabled={!ready}
            className="inline-flex items-center justify-center gap-2 bg-brand hover:bg-brand-dark text-white font-semibold px-8 py-3.5 rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-brand/25 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            Get Started →
          </button>
          <button
            ...
            disabled={!ready}
            className="inline-flex items-center justify-center gap-2 border border-border bg-card hover:bg-accent text-foreground font-semibold px-8 py-3.5 rounded-xl transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            View Dashboard
          </button>
        </div>
