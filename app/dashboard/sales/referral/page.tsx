...
const neoCard = "bg-white border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000]";
const neoBtnDark =
...
const neoBtnMain =
  "bg-[#6be1d9] text-black font-black border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px] active:shadow-none";
        ...
        <div className="bg-[#f0fdfa] min-h-full p-6 md:p-8 animate-pulse">
          <div className="max-w-7xl mx-auto space-y-6">
            <div className="space-y-2 mb-8">
              <div className="h-10 w-72 bg-[#e0e0e0] rounded-[15px]" />
              <div className="h-4 w-96 bg-[#e0e0e0] rounded-[15px]" />
            </div>
            <div className="grid grid-cols-12 gap-6">
              <div className="col-span-12 lg:col-span-8 space-y-6">
                <div className="bg-white border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000] p-8 space-y-4">
                  <div className="h-3 w-28 bg-[#e0e0e0] rounded-[15px]" />
                  <div className="flex gap-4">
                    <div className="flex-1 h-14 bg-[#e0e0e0] rounded-[15px]" />
                    <div className="h-14 w-24 bg-[#e0e0e0] rounded-[15px]" />
                  </div>
                  <div className="h-12 w-full bg-[#e0e0e0] rounded-[15px]" />
                </div>
                <div className="grid grid-cols-3 gap-5">
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="bg-white border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000] p-6 space-y-4">
                      <div className="h-3 w-24 bg-[#e0e0e0] rounded-[15px]" />
                      <div className="h-8 w-12 bg-[#e0e0e0] rounded-[15px]" />
                    </div>
                  ))}
                </div>
                <div className="bg-white border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000] overflow-hidden">
                  <div className="p-5 border-b-2 border-black">
                    <div className="h-5 w-32 bg-[#e0e0e0] rounded-[15px]" />
                  </div>
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="flex gap-6 px-6 py-4 border-b border-black/10">
                      <div className="h-4 flex-1 bg-[#e0e0e0] rounded-[15px]" />
                      <div className="h-4 w-28 bg-[#e0e0e0] rounded-[15px]" />
                      <div className="h-4 w-24 bg-[#e0e0e0] rounded-[15px]" />
                    </div>
                  ))}
                </div>
              </div>
              <aside className="col-span-12 lg:col-span-4 space-y-6">
                <div className="bg-white border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000] p-6 space-y-4">
                  <div className="h-5 w-32 bg-[#e0e0e0] rounded-[15px]" />
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="flex gap-3">
                      <div className="w-10 h-10 bg-[#e0e0e0] rounded-[15px] shrink-0" />
                      <div className="flex-1 space-y-2">
                        <div className="h-3 w-24 bg-[#e0e0e0] rounded-[15px]" />
                        <div className="h-3 w-full bg-[#e0e0e0] rounded-[15px]" />
                      </div>
                    </div>
                  ))}
                </div>
                <div className="bg-[#e0e0e0] border-2 border-black rounded-[15px] h-40" />
                <div className="bg-[#e0e0e0] border-2 border-black rounded-[15px] h-36" />
              </aside>
            </div>
          </div>
        </div>
    ...
    <SidebarLayout role="SALES">
      <div className="bg-[#f0fdfa] min-h-full p-6 md:p-8 animate-fade-in">
        <div className="max-w-7xl mx-auto">
          ...
          {!referralData ? (
            <div className="py-20 border-2 border-dashed border-black rounded-[15px] bg-white flex flex-col items-center text-center">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 lg:col-span-8 space-y-6">
                ...
                <section className={`${neoCard} p-6 md:p-8 bg-[#6be1d9]/5`}>
                  ...
                  <div className="flex flex-col md:flex-row items-stretch gap-4 mt-2 w-full">

                    {/* Link Container: Tambahkan min-w-0 agar truncate berfungsi di dalam flex */}
                    <div className="flex-1 min-w-0 bg-white border-2 border-black rounded-[15px] px-5 py-4 flex items-center justify-between gap-3 shadow-[2px_2px_0px_0px_#000]">
                    ...
                    {/* Buttons Container: Tambahkan shrink-0 agar tombol tidak gepeng atau terdorong keluar */}
                    <div className="flex gap-3 shrink-0">
                      ...
                      <button
                        ...
                        className="flex items-center justify-center bg-white border-2 border-black rounded-[15px] px-5 py-4 shadow-[4px_4px_0px_0px_#000] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none shrink-0"
                      >
                        <Share2 size={16} />
                      </button>
                    </div>
                  ...
                  {/* Info strip */}
                  <div className="mt-6 p-4 bg-white border-2 border-black rounded-[15px] flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div className={`${neoCard} p-6 flex flex-col justify-between`}>
                    ...
                    <div className="flex items-end justify-between mt-4">
                      ...
                      <div className="w-12 h-12 bg-[#6be1d9] border-2 border-black flex items-center justify-center shadow-[2px_2px_0px_0px_#000] rounded-[15px]">
                        <Users size={20} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-black text-white border-2 border-black rounded-[15px] shadow-[4px_4px_0px_0px_#000] p-6 flex flex-col justify-between">
                    ...
                    <div className="flex items-end justify-between mt-4">
                      ...
                      <div className="w-12 h-12 bg-white text-black border-2 border-black flex items-center justify-center shadow-[2px_2px_0px_0px_#6be1d9] rounded-[15px]">
                        <CreditCard size={20} />
                      </div>
                    </div>
                  </div>
                ...
                <div className={`${neoCard} overflow-hidden`}>
                  <div className="px-6 py-5 border-b-2 border-black flex justify-between items-center bg-white">
                    ...
                    {referredUsers.length > 0 && (
                      <span className="text-xs font-black text-black border-2 border-black px-3 py-1 rounded-[15px]">
              ...
              <aside className="col-span-12 lg:col-span-4 space-y-6">
                  ...
                  {rewards.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {rewards.slice(0, 4).map((r, i) => (
                        <div
                          key={i}
                          className="flex items-start gap-4 p-3 border-2 border-transparent hover:border-black hover:bg-[#6be1d9]/10 transition-all rounded-[15px]"
                        >
                ...
                {/* Leaderboard Status */}
                <section className="bg-black text-white border-2 border-black shadow-[4px_4px_0px_0px_#000] rounded-[15px] p-8 relative overflow-hidden">
                  ...
                  <div className="mt-8 w-full bg-white/20 h-4 border-2 border-white rounded-[15px] relative z-10 overflow-hidden">
                    <div
                ...
                {/* How it Works */}
                <section className="bg-[#FACC00] border-2 border-black shadow-[4px_4px_0px_0px_#000] rounded-[15px] p-6 relative overflow-hidden">
